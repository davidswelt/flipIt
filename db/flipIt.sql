...
CREATE TABLE `bonus` (
  ...
  CONSTRAINT `bonus_ibfk_4` FOREIGN KEY (`info_treatment_id`) REFERENCES `info_treatment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `bonus_ibfk_5` FOREIGN KEY (`session_id`) REFERENCES `gameSession` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `gameResult` (
  ...
  PRIMARY KEY (`id`),
  KEY `run_id` (`run_id`),
  CONSTRAINT `gameResult_ibfk_2` FOREIGN KEY (`run_id`) REFERENCES `gameRun` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `gameRun` (
  ...
  KEY `session_id` (`session_id`),
  CONSTRAINT `gameRun_ibfk_2` FOREIGN KEY (`session_id`) REFERENCES `gameSession` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `gameSession` (
  ...
  CONSTRAINT `gameSession_ibfk_2` FOREIGN KEY (`info_treatment_id`) REFERENCES `info_treatment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `gameSession_ibfk_4` FOREIGN KEY (`visual_treatment_id`) REFERENCES `visual_treatment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2013-10-17 19:04:18
